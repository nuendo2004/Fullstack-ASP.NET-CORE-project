...
function SearchBySpeedId() {
  ...
  const [searchSpeed, setSearchSpeed] = useState({ searchQuery: "" });
  ...
  const onSearch = (e) => {
    e.preventDefault();
    const query = searchSpeed.searchQuery;
    ...
    <React.Fragment>
      <div className="input-group row">
        <div className="form-outline">
          <input
            value={SearchBySpeedId.searchQuery}
          ...
          <div className="container">
            <Table className="text-nowrap table-primary">
              ...
              {showSpeed && pageData.searchResult}
            </Table>
          </div>
        </div>
      </div>
...
export default SearchBySpeedId;
